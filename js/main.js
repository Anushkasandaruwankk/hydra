...
async function initialize() {
    ...
    document.getElementById("time").innerHTML = hh + ":" + min + " " + ampm;
...
function showLscmd() {
    ...
    consoleDisplay.innerHTML += "open channel - open the user's youtube channel</br>";
...
function userInfo() {
    ...
    consoleDisplay.innerHTML += "Mobile number: <a href=\"callto:0094712619890\">+94712619890</a></br>";
...
async function openChannel() {
    var consoleDisplay = document.getElementById("console-display");
    consoleDisplay.innerHTML += "Opening youtube channel...</br>";
    await sleep(200);
    window.open("https://www.youtube.com/channel/UCvTEDSjZjUqXtcZavUnWGxw?view_as=subscriber", "_blank").focus();
    consoleDisplay.innerHTML += "Youtube channel opened...</br></br>";
}
